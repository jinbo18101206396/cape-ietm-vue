  ...
  <div class="home">
    ...
    <a-card style="margin-bottom: 3rem">
      <ellipsis :length="100" tooltip>
        ...
        fourth incident in September,a according to the safety recall report. After meeting with US regulators in October, the firm decided to issue a voluntary recall.
      </ellipsis>
    </a-card>
