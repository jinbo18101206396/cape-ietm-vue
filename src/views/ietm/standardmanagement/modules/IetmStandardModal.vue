        ...
        <a-row>
          <a-col :span="24">
            <a-form-model-item label="标准名称" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="name">
              <a-input v-model="model.name" placeholder="请输入标准名称" ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/standardmanagement/ietmStandard/add",
          edit: "/standardmanagement/ietmStandard/edit",
        }
